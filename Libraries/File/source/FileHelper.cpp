...
std::vector<char> FileHelper::FileOpenV(const char* const fileName, GD::File::Mode openMode, GD::File::Error* out_status)
{
...
std::string FileHelper::FileOpenS(const char* const fileName, GD::File::Mode openMode, GD::File::Error* out_status)
{
	File::Handle fileHandle;
